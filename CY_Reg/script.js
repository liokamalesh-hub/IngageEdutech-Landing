/**
 * Google Cyber Security Program - inGage Edutech
 * 100% Pure Vanilla JavaScript (Zero Frameworks, Zero Dependencies)
 */

// Course title mappings
const courseNames = {
  'generative-ai': 'Google Generative AI Program',
  'cloud-foundations': 'Google Cloud Computing Foundations',
  'cloud-engineering': 'Google Cloud Engineering Program',
 ...
 * @param {'generative-ai' | 'cloud-foundations' | 'cloud-engineering'} courseId
 */
function selectCourse(courseId) {
  ...
  const cards = ['generative-ai', 'cloud-foundations', 'cloud-engineering'];
  cards.forEach((id) => {
...
function handleFormSubmit() {
  ...
  alert(`Form verified successfully!\n\nProceeding to secure checkout for ₹499.\nYou will receive instant enrollment access to Google Cyber Security + complimentary access to ${selectedName}.`);
}
